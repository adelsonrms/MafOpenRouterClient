...
Utilize o `RunStreamingAsync` para uma experiência de UI muito melhor no console. O exemplo abaixo mostra como exibir o nome do agente em uma linha separada e com cores quando a resposta começa a chegar.
